...
from SpotifyXAdnan import AUTH_CHATS, LOG_GROUP,SpotifyXAdnan
from deezer import Client
from os import mkdir
from random import randint
from SpotifyXAdnan.utils.mainhelper import fetch_tracks,download_songs,parse_deezer_url,thumb_down


client = Client()


@SpotifyXAdnan.on_message(filters.regex(r'https?://.*deezer[^\s]+') & filters.private | filters.regex(r'https?://.*deezer[^\s]+') & filters.command("deezer") & filters.chat(AUTH_CHATS))
