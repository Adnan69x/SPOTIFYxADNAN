...
from SpotifyXAdnan import AUTH_CHATS, LOG_GROUP, LOGGER, SpotifyXAdnan
from pyrogram import filters
from SpotifyXAdnan.utils.ytdl import getIds,ytdl_down,audio_opt,thumb_down

@SpotifyXAdnan.on_message(filters.regex(r'(https?://)?.*you[^\s]+') & filters.private | filters.command(["yt","ytd","ytmusic"]) & filters.regex(r'https?://.*you[^\s]+') & filters.chat(AUTH_CHATS))
